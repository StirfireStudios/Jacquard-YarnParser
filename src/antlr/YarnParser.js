...
var ruleNames =  [ "dialogue", "node", "header", "body", "statement", "ostatement", 
                   ...
                   "command_statement", "function_call", "text", "set_operands", 
                   "keyword", "expression", "operand", "value" ];
...
YarnParser.RULE_set_operands = 24;
YarnParser.RULE_keyword = 25;
YarnParser.RULE_expression = 26;
YarnParser.RULE_operand = 27;
YarnParser.RULE_value = 28;
...
YarnParser.prototype.set_operands = function() {
    ...
    this.enterRule(localctx, 48, YarnParser.RULE_set_operands);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 286;
        _la = this._input.LA(1);
        if(!(((((_la - 43)) & ~0x1f) == 0 && ((1 << (_la - 43)) & ((1 << (YarnParser.ADD_EQUALS - 43)) | (1 << (YarnParser.MINUS_EQUALS - 43)) | (1 << (YarnParser.MULTIPLY_EQUALS - 43)) | (1 << (YarnParser.DIVIDE_EQUALS - 43)) | (1 << (YarnParser.MODULO_EQUALS - 43)) | (1 << (YarnParser.KEYWORD_TO - 43)))) !== 0))) {
...
YarnParser.prototype.keyword = function() {
    ...
    this.enterRule(localctx, 50, YarnParser.RULE_keyword);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 288;
...
YarnParser.prototype.expression = function(_p) {
    ...
    var _startState = 52;
    this.enterRecursionRule(localctx, 52, YarnParser.RULE_expression, _p);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 301;
        this._errHandler.sync(this);
...
YarnParser.prototype.operand = function() {
    ...
    this.enterRule(localctx, 54, YarnParser.RULE_operand);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 312;
...
YarnParser.prototype.value = function() {
    ...
    this.enterRule(localctx, 56, YarnParser.RULE_value);
    try {
        this.state = 320;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
