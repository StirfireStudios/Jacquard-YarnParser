...
var symbolicNames = [ null, "OPTION_START", "OPTION_END", "COMMAND_START", 
                      ...
                      "BODY_WS", "BODY_END", "BODY_COMMENT", "BODY_BLOCK_COMMENT", 
...
var ruleNames =  [ "dialogue", "node", "header", "body", "statement", "ostatement", 
                   ...
                   "text", "set_operands", "keyword_start", "keyword", "expression", 
                   "operand", "assignmentOperand", "value" ];
...
YarnParser.BODY_WS = 17;
YarnParser.BODY_END = 18;
YarnParser.BODY_COMMENT = 19;
YarnParser.BODY_BLOCK_COMMENT = 20;
YarnParser.OPTION_WS = 21;
YarnParser.OPTION_BLOCK_COMMENT = 22;
YarnParser.OPTION_SEPARATOR = 23;
YarnParser.COMMAND_WS = 24;
YarnParser.COMMAND_BLOCK_COMMENT = 25;
YarnParser.LBRACKET = 26;
YarnParser.RBRACKET = 27;
YarnParser.COMMA = 28;
YarnParser.PLUS = 29;
YarnParser.MINUS = 30;
YarnParser.MULTIPLY = 31;
YarnParser.DIVIDE = 32;
YarnParser.MODULO = 33;
YarnParser.EQ = 34;
YarnParser.GT = 35;
YarnParser.LT = 36;
YarnParser.NEQ = 37;
...
YarnParser.OR = 42;
YarnParser.XOR = 43;
YarnParser.ADD_EQUALS = 44;
YarnParser.MINUS_EQUALS = 45;
YarnParser.MULTIPLY_EQUALS = 46;
YarnParser.DIVIDE_EQUALS = 47;
YarnParser.MODULO_EQUALS = 48;
YarnParser.KEYWORD_TO = 49;
YarnParser.KEYWORD_SET = 50;
YarnParser.KEYWORD_FUNC = 51;
YarnParser.KEYWORD_IF = 52;
YarnParser.KEYWORD_ELSE = 53;
YarnParser.KEYWORD_ELSE_IF = 54;
YarnParser.KEYWORD_ENDIF = 55;
YarnParser.KEYWORD_TRUE = 56;
YarnParser.KEYWORD_FALSE = 57;
YarnParser.KEYWORD_NULL = 58;
YarnParser.VARIABLE = 59;
YarnParser.NUMBER = 60;
YarnParser.STRING = 61;
...
YarnParser.RULE_keyword_start = 26;
YarnParser.RULE_keyword = 27;
YarnParser.RULE_expression = 28;
YarnParser.RULE_operand = 29;
YarnParser.RULE_assignmentOperand = 30;
YarnParser.RULE_value = 31;
...
YarnParser.prototype.body = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << YarnParser.OPTION_START) | (1 << YarnParser.COMMAND_START) | (1 << YarnParser.EVAL_START) | (1 << YarnParser.SHORTCUT_START) | (1 << YarnParser.TEXT) | (1 << YarnParser.NEWLINE))) !== 0)) {
            this.state = 87;
            this._errHandler.sync(this);
...
Of_statementContext.prototype.ostatement = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
Function_commandContext.prototype.COMMAND_START = function() {
    return this.getToken(YarnParser.COMMAND_START, 0);
};
...
Function_commandContext.prototype.KEYWORD_FUNC = function() {
...
CommandContext.prototype.EVAL_START = function(i) {
	if(i===undefined) {
		i = null;
	}
    if(i===null) {
        return this.getTokens(YarnParser.EVAL_START);
    } else {
        return this.getToken(YarnParser.EVAL_START, i);
    }
};
...
CommandContext.prototype.EVAL_END = function(i) {
	if(i===undefined) {
		i = null;
	}
    if(i===null) {
        return this.getTokens(YarnParser.EVAL_END);
    } else {
        return this.getToken(YarnParser.EVAL_END, i);
    }
};


CommandContext.prototype.keyword_start = function() {
    return this.getTypedRuleContext(Keyword_startContext,0);
};
...
YarnParser.prototype.command_statement = function() {
    ...
    try {
        ...
        case 3:
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            while(_la===YarnParser.EVAL_START || _la===YarnParser.TEXT || ((((_la - 49)) & ~0x1f) == 0 && ((1 << (_la - 49)) & ((1 << (YarnParser.KEYWORD_TO - 49)) | (1 << (YarnParser.KEYWORD_SET - 49)) | (1 << (YarnParser.KEYWORD_FUNC - 49)) | (1 << (YarnParser.KEYWORD_IF - 49)) | (1 << (YarnParser.KEYWORD_ELSE - 49)) | (1 << (YarnParser.KEYWORD_ELSE_IF - 49)) | (1 << (YarnParser.KEYWORD_ENDIF - 49)) | (1 << (YarnParser.KEYWORD_TRUE - 49)) | (1 << (YarnParser.KEYWORD_FALSE - 49)) | (1 << (YarnParser.KEYWORD_NULL - 49)) | (1 << (YarnParser.VARIABLE - 49)))) !== 0)) {
                this.state = 315;
                this._errHandler.sync(this);
                switch(this._input.LA(1)) {
                case YarnParser.TEXT:
...
YarnParser.prototype.function_call = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << YarnParser.TEXT) | (1 << YarnParser.LBRACKET) | (1 << YarnParser.MINUS))) !== 0) || ((((_la - 40)) & ~0x1f) == 0 && ((1 << (_la - 40)) & ((1 << (YarnParser.NOT - 40)) | (1 << (YarnParser.KEYWORD_TO - 40)) | (1 << (YarnParser.KEYWORD_SET - 40)) | (1 << (YarnParser.KEYWORD_FUNC - 40)) | (1 << (YarnParser.KEYWORD_IF - 40)) | (1 << (YarnParser.KEYWORD_ELSE - 40)) | (1 << (YarnParser.KEYWORD_ELSE_IF - 40)) | (1 << (YarnParser.KEYWORD_ENDIF - 40)) | (1 << (YarnParser.KEYWORD_TRUE - 40)) | (1 << (YarnParser.KEYWORD_FALSE - 40)) | (1 << (YarnParser.KEYWORD_NULL - 40)) | (1 << (YarnParser.VARIABLE - 40)) | (1 << (YarnParser.NUMBER - 40)) | (1 << (YarnParser.STRING - 40)))) !== 0)) {
            this.state = 328;
...
YarnParser.prototype.set_operands = function() {
    ...
    try {
        ...
        this.state = 347;
        _la = this._input.LA(1);
        if(!(((((_la - 44)) & ~0x1f) == 0 && ((1 << (_la - 44)) & ((1 << (YarnParser.ADD_EQUALS - 44)) | (1 << (YarnParser.MINUS_EQUALS - 44)) | (1 << (YarnParser.MULTIPLY_EQUALS - 44)) | (1 << (YarnParser.DIVIDE_EQUALS - 44)) | (1 << (YarnParser.MODULO_EQUALS - 44)) | (1 << (YarnParser.KEYWORD_TO - 44)))) !== 0))) {
...
function Keyword_startContext(parser, parent, invokingState) {
	if(parent===undefined) {
	    parent = null;
	}
	if(invokingState===undefined || invokingState===null) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = YarnParser.RULE_keyword_start;
    return this;
}

Keyword_startContext.prototype = Object.create(antlr4.ParserRuleContext.prototype);
Keyword_startContext.prototype.constructor = Keyword_startContext;

Keyword_startContext.prototype.KEYWORD_TO = function() {
    return this.getToken(YarnParser.KEYWORD_TO, 0);
};

Keyword_startContext.prototype.KEYWORD_SET = function() {
    return this.getToken(YarnParser.KEYWORD_SET, 0);
};

Keyword_startContext.prototype.KEYWORD_FUNC = function() {
    return this.getToken(YarnParser.KEYWORD_FUNC, 0);
};

Keyword_startContext.prototype.KEYWORD_TRUE = function() {
    return this.getToken(YarnParser.KEYWORD_TRUE, 0);
};

Keyword_startContext.prototype.KEYWORD_FALSE = function() {
    return this.getToken(YarnParser.KEYWORD_FALSE, 0);
};

Keyword_startContext.prototype.KEYWORD_NULL = function() {
    return this.getToken(YarnParser.KEYWORD_NULL, 0);
};

Keyword_startContext.prototype.enterRule = function(listener) {
    if(listener instanceof YarnParserListener ) {
        listener.enterKeyword_start(this);
	}
};

Keyword_startContext.prototype.exitRule = function(listener) {
    if(listener instanceof YarnParserListener ) {
        listener.exitKeyword_start(this);
	}
};
...
YarnParser.Keyword_startContext = Keyword_startContext;

YarnParser.prototype.keyword_start = function() {

    var localctx = new Keyword_startContext(this, this._ctx, this.state);
    this.enterRule(localctx, 52, YarnParser.RULE_keyword_start);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 349;
        _la = this._input.LA(1);
        if(!(((((_la - 49)) & ~0x1f) == 0 && ((1 << (_la - 49)) & ((1 << (YarnParser.KEYWORD_TO - 49)) | (1 << (YarnParser.KEYWORD_SET - 49)) | (1 << (YarnParser.KEYWORD_FUNC - 49)) | (1 << (YarnParser.KEYWORD_TRUE - 49)) | (1 << (YarnParser.KEYWORD_FALSE - 49)) | (1 << (YarnParser.KEYWORD_NULL - 49)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
...
YarnParser.prototype.keyword = function() {
    ...
    this.enterRule(localctx, 54, YarnParser.RULE_keyword);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 351;
        _la = this._input.LA(1);
        if(!(((((_la - 49)) & ~0x1f) == 0 && ((1 << (_la - 49)) & ((1 << (YarnParser.KEYWORD_TO - 49)) | (1 << (YarnParser.KEYWORD_SET - 49)) | (1 << (YarnParser.KEYWORD_FUNC - 49)) | (1 << (YarnParser.KEYWORD_IF - 49)) | (1 << (YarnParser.KEYWORD_ELSE - 49)) | (1 << (YarnParser.KEYWORD_ELSE_IF - 49)) | (1 << (YarnParser.KEYWORD_ENDIF - 49)) | (1 << (YarnParser.KEYWORD_TRUE - 49)) | (1 << (YarnParser.KEYWORD_FALSE - 49)) | (1 << (YarnParser.KEYWORD_NULL - 49)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
...
YarnParser.prototype.expression = function(_p) {
    ...
    var _startState = 56;
    this.enterRecursionRule(localctx, 56, YarnParser.RULE_expression, _p);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 368;
        this._errHandler.sync(this);
...
YarnParser.prototype.operand = function() {
    ...
    this.enterRule(localctx, 58, YarnParser.RULE_operand);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 379;
        _la = this._input.LA(1);
        if(!(((((_la - 29)) & ~0x1f) == 0 && ((1 << (_la - 29)) & ((1 << (YarnParser.PLUS - 29)) | (1 << (YarnParser.MINUS - 29)) | (1 << (YarnParser.MULTIPLY - 29)) | (1 << (YarnParser.DIVIDE - 29)) | (1 << (YarnParser.MODULO - 29)) | (1 << (YarnParser.EQ - 29)) | (1 << (YarnParser.GT - 29)) | (1 << (YarnParser.LT - 29)) | (1 << (YarnParser.NEQ - 29)) | (1 << (YarnParser.GTE - 29)) | (1 << (YarnParser.LTE - 29)) | (1 << (YarnParser.AND - 29)) | (1 << (YarnParser.OR - 29)) | (1 << (YarnParser.XOR - 29)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
...
YarnParser.prototype.assignmentOperand = function() {
    ...
    this.enterRule(localctx, 60, YarnParser.RULE_assignmentOperand);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 381;
        _la = this._input.LA(1);
        if(!(((((_la - 44)) & ~0x1f) == 0 && ((1 << (_la - 44)) & ((1 << (YarnParser.ADD_EQUALS - 44)) | (1 << (YarnParser.MINUS_EQUALS - 44)) | (1 << (YarnParser.MULTIPLY_EQUALS - 44)) | (1 << (YarnParser.DIVIDE_EQUALS - 44)) | (1 << (YarnParser.MODULO_EQUALS - 44)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
...
YarnParser.prototype.value = function() {
    ...
    this.enterRule(localctx, 62, YarnParser.RULE_value);
    try {
        this.state = 389;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
