...
YarnParser.prototype.body = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << YarnParser.OPTION_START) | (1 << YarnParser.COMMAND_START) | (1 << YarnParser.EVAL_START) | (1 << YarnParser.SHORTCUT_START) | (1 << YarnParser.TEXT) | (1 << YarnParser.HASHTAG) | (1 << YarnParser.NEWLINE) | (1 << YarnParser.SET_COMMAND_START) | (1 << YarnParser.FUNC_COMMAND_START) | (1 << YarnParser.IF_COMMAND_START))) !== 0)) {
            this.state = 85;
            this._errHandler.sync(this);
...
BlankContext.prototype.NEWLINE = function(i) {
	if(i===undefined) {
		i = null;
	}
    if(i===null) {
...
function LineGroupContext(parser, ctx) {
	StatementContext.call(this, parser);
    StatementContext.prototype.copyFrom.call(this, ctx);
    return this;
}

LineGroupContext.prototype = Object.create(StatementContext.prototype);
LineGroupContext.prototype.constructor = LineGroupContext;

YarnParser.LineGroupContext = LineGroupContext;

LineGroupContext.prototype.text = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
LineGroupContext.prototype.command_statement = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
LineGroupContext.prototype.eval_statement = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
LineGroupContext.prototype.enterRule = function(listener) {
    if(listener instanceof YarnParserListener ) {
        listener.enterLineGroup(this);
	}
};

LineGroupContext.prototype.exitRule = function(listener) {
    if(listener instanceof YarnParserListener ) {
        listener.exitLineGroup(this);
	}
};


function EndOfLineContext(parser, ctx) {
	StatementContext.call(this, parser);
    StatementContext.prototype.copyFrom.call(this, ctx);
    return this;
}

EndOfLineContext.prototype = Object.create(StatementContext.prototype);
EndOfLineContext.prototype.constructor = EndOfLineContext;

YarnParser.EndOfLineContext = EndOfLineContext;

EndOfLineContext.prototype.NEWLINE = function() {
...
function HashtagContext(parser, ctx) {
	StatementContext.call(this, parser);
...
HashtagContext.prototype = Object.create(StatementContext.prototype);
HashtagContext.prototype.constructor = HashtagContext;

YarnParser.HashtagContext = HashtagContext;

HashtagContext.prototype.HASHTAG = function(i) {
	if(i===undefined) {
		i = null;
	}
    if(i===null) {
...
YarnParser.prototype.statement = function() {
    ...
    try {
        ...
        case 3:
            localctx = new LineGroupContext(this, localctx);
        ...
        case 4:
            localctx = new HashtagContext(this, localctx);
        ...
        case 5:
            localctx = new EndOfLineContext(this, localctx);
...
LeftRightExpressionContext.prototype.KEYWORD_IF = function() {
